...
import analyzer.ast.ParseException;
import analyzer.ast.Parser;
import analyzer.visitors.PrintExpressionDAGVisitor;
import analyzer.visitors.PrintOptimizedCodeVisitor;
...
public class Main {
    ...
    // by the test cases.
    public static void Run(InputStream input, PrintWriter output) throws ParseException {
        ...
        PrintExpressionDAGVisitor printExpressionDAGVisitor = new PrintExpressionDAGVisitor(output);
        root.jjtAccept(printExpressionDAGVisitor, null);

        PrintOptimizedCodeVisitor printOptimizedCodeVisitor = new PrintOptimizedCodeVisitor(output);
        root.jjtAccept(printOptimizedCodeVisitor, null);
